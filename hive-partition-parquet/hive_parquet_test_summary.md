...
共 **7 大类 50+ 项** 测试，覆盖研发文档（hive_partition_user_guide_en.md）所有功能点：

| 类别 | 测试项数 | 说明 |
|------|---------|------|
| 功能验证 | 23 项 | 分区裁剪、非裁剪谓词、虚拟列、NULL 分区、深度不匹配等 |
...
| **文档覆盖** | 文档所有功能点均已验证通过 |
| **遗留问题** | 5 个 open bug + 2 个 enhancement，#24374 (panic) 最需优先修复 |
