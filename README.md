...
| 日期 | 报告 | 说明 |
|------|------|------|
| 2026-09-09 | [Apache Arrow IPC LOAD DATA 阶段测试记录](arrow-load-test-design/test-results-20260909.md) | 候选提交 `f0c31cd4b8`：public MySQL path、MinIO/stage、多 CN、事务/回滚、重启、配置门禁、3 轮重复、race 与 fuzz 的阶段结果 |
...
| 2026-09-06 | [MySQL 兼容性契约](mysql-compatibility-contract/README.md) | 记录 MatrixOne 明确不支持的 MySQL 行为、窄范围支持例外和已确认结果差异 |
