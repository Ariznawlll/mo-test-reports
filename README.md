...
| 日期 | 报告 | 说明 |
|------|------|------|
| 2026-06-11 | [Checkpoint Dump 工具测试方案](docs/checkpoint_dump_test_plan.md) | `mo-tool ckp dump` 功能、全表类型、全数据类型、约束、unhappy path、性能、dump + load 正确性、3.0-dev 到 4.0-dev 兼容性测试 |
